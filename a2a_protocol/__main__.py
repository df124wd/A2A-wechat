...
def research_to_write_trace(task: str, model_client: ModelClient | None = None) -> dict:
    ...
    return {
        ...
        "participants": [
            ...
            {
                "participant_id": "tool.capability_registry",
                "kind": "tool",
        ...
        "messages": [
            ...
            },
            {
                "envelope": envelope(
                    ...
                    "tool_call",
                    "corr_capability_research",
                    "msg_user_request",
                ),
                "content": {
                    "summary": "Planner Agent asks Capability Registry who can handle research.web.",
                    "data": {
            ...
            {
                "envelope": envelope(
                    "msg_capability_research_result",
                    trace_id,
                    task_id,
                    conversation_id,
                    3,
                ...
                "content": {
                    "summary": "Capability Registry returns Research Agent as the research.web match.",
                    "data": {
                        "capability": "research.web",
                        "matches": ["agent.researcher"],
                    },
                },
            },
            {
                ...
                "content": {
                    ...
                    "data": {
                        "goal": f"Gather source material for: {task}",
                        "selected_by_capability": "research.web",
                        "source_message_id": "msg_capability_research_result",
                    },
                },
            },
            {
